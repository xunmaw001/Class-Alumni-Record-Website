		...
		<div id="app">
			...
			<div class="data-add-container">
				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
						...
						<div class="layui-input-block">
							<input v-model="detail.zaixiaoshijian" type="text" name="zaixiaoshijian" id="zaixiaoshijian" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                            
                                                                                                                                                                                    <div class="layui-form-item" pane>
						<label class="layui-form-label">风光事迹：</label>
						<div class="layui-input-block">
							<textarea name="fengguangshiji" id="fengguangshiji">请输入风光事迹</textarea>
						</div>
					</div>
		...
		<script>
			...
			layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate','tinymce'], function() {
				...
				form.on('submit(*)', function(data) {
                    ...
                    // 数据校验
					                    					                                                                                                                                                                					                                                                                                                                                                					                                                                                                                                                                					var fengguangshiji = tinymce.get('#fengguangshiji').getContent()
					data.fengguangshiji = fengguangshiji;
					...
					// 提交数据
					http.requestJson('xiaoyoufengcai' + '/add', 'post', data, function(res) {
					 	layer.msg('提交成功', {
					 		time: 2000,
					 		icon: 6
					 	}, function() {
