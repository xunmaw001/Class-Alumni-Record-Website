...
<body>
  <div id="app">
    ...
    <div class="about-culture-box">
      <div class="about-culture">
        ...
        <div class="about-culture-piclist">
          <ul>
            <li v-for="(item,index) in xiaoyoufengcaiList" v-bind:key="index" @click="jump('../xiaoyoufengcai/detail.jsp?id='+item.id)">
              <img :src="item.tupian?item.tupian.split(',')[0]:''" width="310" height="350" />
              <div class="about-culture-words">
                <h6>{{item.xingming}}</h6>
                <p v-if="item.price">{{item.price}} RMB</p>
  ...
  <script>
    ...
    layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery'], function() {
      ...
      http.request(`xiaoyoufengcai/list`, 'get', {
        page: 1,
        limit: 6
      }, function(res) {
        vue.xiaoyoufengcaiList = res.data.list;
      });
    });
  </script>
</body>
