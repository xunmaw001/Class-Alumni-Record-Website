...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">聚会报名管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>聚会报名列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">聚会报名列表</h3>							
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('juhuishijian')">聚会时间<i id="juhuishijianIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('juhuididian')">聚会地点<i id="juhuididianIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var juhuishijianCell  = document.createElement('td');

						  juhuishijianCell.innerHTML = item.juhuishijian;


			row.appendChild(juhuishijianCell);
			var juhuididianCell  = document.createElement('td');

						 juhuididianCell.innerHTML = item.juhuididian;


			row.appendChild(juhuididianCell);
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("juhuibaoming/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"juhuibaoming");
