...
<body>
					...
					<div class="row breadcrumb-bar">
						...
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>同学录管理</span></li>
								<li class="breadcrumb-item active"><span>同学录列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">同学录列表</h3>							
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									...
									<input type="text" id="jiebieSearch" class="form-control form-control-sm" placeholder="" aria-controls="tableId">
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('jiebie')">届别<i id="jiebieIcon" class="fa fa-sort"></i></th>
											<th>操作</th>
										</tr>
									</thead>
									<tbody>
	...
	<script>
		...
		function search(){
			...
			if($('#jiebieSearch').val() != null && $('#jiebieSearch').val() != ''){
				searchForm.jiebie ="%" +  $('#jiebieSearch').val() + "%";
			}
		...
		function setDataRow(item,number){
			...
			var jiebieCell  = document.createElement('td');

						 jiebieCell.innerHTML = item.jiebie;


			row.appendChild(jiebieCell);
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("tongxuelu/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"tongxuelu");
