...
<body>
					...
					<div class="row breadcrumb-bar">
						...
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>同学录统计</span></li>
							</ol>
						</div>
					</div>
				</div>
	...
	$.ajax({ 
		type: "GET",
		url: baseUrl+"value/tongxuelu/"+xColumnName+'/'+yColumnName,
		data:{ },
	...
	function group(colName){
		$.ajax({ 
			type: "GET",
			url: baseUrl+"group/tongxuelu/"+colName,
			data:{	tableName: "tongxuelu",
					columnName: colName
					},
			beforeSend: function(xhr) {
				xhr.setRequestHeader("token", window.sessionStorage.getItem('token'));
